...
void testTwo()
{
    ...
    const Matrix<int, 3, 6> matrix([](std::size_t rowIdx, std::size_t colIdx)
...
void testThree()
{
    ...
    const Matrix<int, 3, 6> other([](std::size_t rowIdx, std::size_t colIdx)
...
void testFour()
{
    ...
    const Matrix<int, 3, 4> left(1);
    const Matrix<int, 4, 6> right(1);
...
void testSix()
{
    ...
    const Matrix<int, 8, 8> left([](std::size_t rowIdx, std::size_t colIdx)
                                 { return (colIdx == rowIdx + 1) ? 1 : 0; });
    const Matrix<int, 8, 8> right([](std::size_t rowIdx, std::size_t colIdx)
                                  { return rowIdx - colIdx - 1; });
...
void testEight()
{
    ...
    const Matrix<int, 6, 3> matrix([](std::size_t rowIdx, std::size_t colIdx)
                                   { return colIdx - rowIdx + 1; });
    const Matrix<int, 3, 6> transpose = matrix.transpose();
    transpose.print();
}
...
void testNine()
{
    ...
    const Matrix<int, 12, 12> matrix([](std::size_t rowIdx, std::size_t colIdx)
                                     { return rowIdx - colIdx; });
    const Matrix<int, 8, 8> submatrix = matrix.submatrix<8, 8>(3, 2);
    submatrix.print();
}
...
void testTen()
{
    ...
    const Matrix<int, 6, 6> submatrix([](std::size_t rowIdx, std::size_t colIdx)
                                      { return rowIdx - colIdx; });
